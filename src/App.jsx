...
import SianGeoWidget from './components/SianGeoWidget';
import CreditScoreWidget from './components/CreditScoreWidget'; // ADD THIS IMPORT
      ...
      <main className="app-main">
        {activeTab === 'dashboard' && (
          <div className="dashboard">
            ...
            {/* SianGeo Widget - Satellite Crop Health */}
            <SianGeoWidget />
            
            {/* Credit Score Widget - Financial Intelligence */}
            <CreditScoreWidget farmId="TEST001" />
